...
import com.example.baicuoiky.databinding.ActivityAddQuestionBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnUploadQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (correct == -1){
                    Toast.makeText( AddQuestionActivity.this, "Phải chọn câu trả lời!", Toast.LENGTH_SHORT).show();
                    return;
                }
